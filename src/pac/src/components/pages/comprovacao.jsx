...
import MensagemConfirmacao from "../components/MensagemConfirmacao";
...
function Comprovacao() {
  ...
  return (
    <section className="page-comprovacao">
      ...
      {mensagemConfirmacao && (
        <MensagemConfirmacao setMensagemConfirmacao={setMensagemConfirmacao} />
      )}
      ...
      {currentAba == "codigo" && (
        <Camera setMensagemConfirmacao={setMensagemConfirmacao} />
      )}
    </section>
  );
}
