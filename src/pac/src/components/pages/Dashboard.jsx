    ...
    <div className="container-main-dashboard">
      <header className="header-dashboard">
        <div className="column">
          ...
          <p>Ciência da Computação · 5º semestre</p>
        </div>
            ...
            <ul className="list-dashboard-eventos">
              ...
              <li>
                ...
                <div className="column">
                  ...
                  <p>
                    <time dateTime="2026-05-01">01/05/2026</time> - 20h -
                    híbrido
                  </p>
                </div>
              </li>
      ...
      <section className="container-meus-eventos display-none">
        ...
        <ul className="lista-eventos-dashboard">
          <li className="card-evento">
            <div className="card-evento-header">
              <h3>Seminário de Inteligência Artificial</h3>
              <span className="badge-status">Em breve</span>
            </div>
        ...
        <div className="meus-eventos-vazio">
          ...
          <button className="btn-explorar-eventos">
            <a href="">Ver eventos disponíveis</a>
          </button>
        </div>
      </section>
    </div>
